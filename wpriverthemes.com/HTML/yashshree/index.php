...
<!-- Mirrored from wpriverthemes.com/HTML/drake/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 27 Feb 2025 08:41:59 GMT -->
<head>
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Yashshree Pachghare</title>
...
<body>
        ...
        <div class="sidebar-menu-inner">
            ...
            <div class="sidebar-social">
                ...
                <ul class="social-links d-flex align-items-center">
                    <li>
                        <a href="pachghareyashshree31@gmail.com" target="_blank"><i class="las la-envelope"></i></a>
                    </li>
                    <li>
                        <a href="https://www.linkedin.com/in/yashshree-pachghare-064066206/" target="_blank"><i class="lab la-linkedin"></i></a>
                    </li>
                    <li>
                        <a href="https://github.com/yasghre" target="_blank"><i class="lab la-github"></i></a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="left-sidebar">
        <div class="sidebar-header d-flex align-items-center justify-content-between">
            <h1 class="designation">Yashshree Pachghare</h1>
        </div>
        <img class="me" src="assets/images/me.jpg" alt="Me">
        <h2 class="email">pachghareyashshree31@gmail.com</h2>
        <h2 class="address">Pune, Maharashtra</h2>
    ...
    <main class="drake-main">
        <div id="smooth-wrapper">
            <div id="smooth-content">
                    ...
                    <div class="custom-container">
                        <div class="hero-content content-width">
                            <div class="section-header">
                                ...
                                <h1 class="scroll-animation" data-animation="fade_from_bottom">I'm <span>Yashshree</span> - Building the Web, One Line at a Time!</h1>
                            </div>
                            <p class="scroll-animation" data-animation="fade_from_bottom">Designing, coding, and creating with PHP, MySQL, JavaScript, React.js, Node.js, HTML & CSS—because I love making the web a better place!</p>
                ...
                <section class="about-area page-section scroll-to-page mt-4" id="about">
                    <div class="custom-container">
                        <div class="about-content content-width">
                            <div class="section-header">
                                ...
                                <h1 class="scroll-animation" data-animation="fade_from_bottom">From Concept to Code - <br> <span>Crafting Digital Experiences</span></h1>
                            </div>
                    ...
                    <div class="custom-container">
                        <div class="resume-content content-width">
                            ...
                            <div class="resume-timeline">
                                ...
                                <div class="item scroll-animation" data-animation="fade_from_right">
                                    <span class="date">Feb 2023 - Oct 2024</span>
                                    <h2>Software Developer</h2>
                                    <p>Unified Voice Communication Pvt. Ltd, Pune</p>
                                </div>
                                <div class="item scroll-animation" data-animation="fade_from_right">
                                ...
                                <div class="item scroll-animation" data-animation="fade_from_right">
                                    ...
                                    <h2>Software Developer</h2>
                                    <p>Techspawn Solutions Pvt. Ltd, Pune</p>
                                </div>
                            </div>
                        ...
                        <div class="services-content content-width">
                            ...
                            <div class="services-items">
                                <div class="service-item scroll-animation" data-animation="fade_from_bottom">
                                    ...
                                    <p>Specializing in fast, scalable, and dynamic web applications using React.js, Node.js, PHP, MySQL, JavaScript, HTML, and CSS. Delivering clean, efficient, and high-performance solutions for websites and complex applications with a seamless user experience.</p>
                                </div>
                                <div class="service-item scroll-animation" data-animation="fade_from_bottom">
                                    <i class="las la-code"></i>
                                    <h2>UI/UX & Responsive Design</h2>
                                    <p>Creating visually stunning and user-friendly interfaces that ensure a seamless experience across all devices. Prioritizing intuitive navigation, modern aesthetics, and responsiveness to enhance user engagement.</p>
                                </div>
                                <div class="service-item scroll-animation" data-animation="fade_from_bottom">
                                    <i class="las la-bezier-curve"></i>
                                    <h2>API & Backend Development</h2>
                                    <p>Building secure, scalable, and high-performance backends using PHP, MySQL, and Node.js. Specializing in API development and database solutions to enable smooth communication between systems.</p>
                                </div>
                                <div class="service-item scroll-animation" data-animation="fade_from_bottom">
                                    <i class="las la-bezier-curve"></i>
                                    <h2>Graphic Design</h2>
                                    <p>Transforming concepts into visually striking designs, from branding to marketing assets. Creating memorable, impactful, and purpose-driven visuals that resonate with audiences and align with business objectives.</p>
                                </div>
                            </div>
                        ...
                        <div class="skills-content content-width">
                            ...
                            <div class="row skills text-center">
                                ...
                                <div class="col-md-3 scroll-animation" data-animation="fade_from_right">
                                    <div class="skill">
                                        <div class="skill-inner">
                                            <img src="assets/images/java-script.png" alt="React">
                                            <h1 class="percent">90%</h1>
                                        </div>
                                        <p class="name">JavaScript (ES6+)</p>
                                    </div>
                                </div>
                                <div class="col-md-3 scroll-animation" data-animation="fade_from_right">
                                    <div class="skill">
                                        <div class="skill-inner">
                                            <img src="assets/images/coding.png" alt="React">
                                            <h1 class="percent">90%</h1>
                                        </div>
                                        <p class="name">HTML, CSS & SCSS</p>
                                    </div>
                                </div>
                                <div class="col-md-3 scroll-animation" data-animation="fade_from_right">
                                    <div class="skill">
                                        <div class="skill-inner">
                                            <img src="assets/images/cascading-style-sheets.png" alt="React">
                                            <h1 class="percent">90%</h1>
                                        </div>
                                ...
                                <div class="col-md-3 scroll-animation" data-animation="fade_from_bottom">
                                    <div class="skill">
                                        <div class="skill-inner">
                                            <img src="assets/images/bootstrap.png" alt="Framer">
                                ...
                                <div class="col-md-3 scroll-animation" data-animation="fade_from_top">
                                    <div class="skill">
                                        <div class="skill-inner">
                                            <img src="assets/images/social.png" alt="Webflow">
                                ...
                                <div class="col-md-3 scroll-animation" data-animation="fade_from_left">
                                    <div class="skill">
                                        <div class="skill-inner">
                                            <img src="assets/images/ajax.png" alt="WordPress">
                                ...
                                <div class="col-md-3 scroll-animation" data-animation="fade_from_bottom">
                                    <div class="skill">
                                        <div class="skill-inner">
                                            <img src="assets/images/nodejs.png" alt="Laravel/PHP">
                                ...
                                <div class="col-md-3 scroll-animation" data-animation="fade_from_bottom">
                                    <div class="skill">
                                        <div class="skill-inner">
                                            <img src="assets/images/nodejs (1).png" alt="Laravel/PHP">
                                            <h1 class="percent">70%</h1>
                                        </div>
                                ...
                                <div class="col-md-3 scroll-animation" data-animation="fade_from_bottom">
                                    <div class="skill">
                                        <div class="skill-inner">
                                            <img src="assets/images/php.png" alt="Laravel/PHP">
                                            <h1 class="percent">70%</h1>
                                        </div>
                                        <p class="name">PHP</p>
                                    </div>
                                ...
                                <div class="col-md-3 scroll-animation" data-animation="fade_from_bottom">
                                    <div class="skill">
                                        <div class="skill-inner">
                                            <img src="assets/images/mysql-database.png" alt="Laravel/PHP">
                                            <h1 class="percent">70%</h1>
                                        </div>
                                ...
                                <div class="col-md-3 scroll-animation" data-animation="fade_from_bottom">
                                    <div class="skill">
                                        <div class="skill-inner">
                                            <img src="assets/images/database.png" alt="Laravel/PHP">
                                            <h1 class="percent">70%</h1>
                                        </div>
                                ...
                                <div class="col-md-3 scroll-animation" data-animation="fade_from_bottom">
                                    <div class="skill">
                                        <div class="skill-inner">
                                            <img src="assets/images/github.png" alt="Laravel/PHP">
                                            <h1 class="percent">70%</h1>
                                        </div>
                                        <p class="name">Git & GitHub</p>
                                    </div>
                                </div>
                                <div class="col-md-3 scroll-animation" data-animation="fade_from_left">
                                    <div class="skill">
                                ...
                                <div class="col-md-3 scroll-animation" data-animation="fade_from_bottom">
                                    <div class="skill">
                                        <div class="skill-inner">
                                            <img src="assets/images/easel.png" alt="Laravel/PHP">
                                            <h1 class="percent">70%</h1>
                                        </div>
                                ...
                                <div class="col-md-3 scroll-animation" data-animation="fade_from_bottom">
                                    <div class="skill">
                                        <div class="skill-inner">
                                            <img src="assets/images/xd.png" alt="Laravel/PHP">
                                            <h1 class="percent">70%</h1>
                                        </div>
                        ...
                        <div class="portfolio-content content-width">
                            ...
                            <div class="row portfolio-items">
                                ...
                                <div class="col-md-6 scroll-animation" data-animation="fade_from_right">
                                    <div class="portfolio-item portfolio-half">
                                        <div class="portfolio-item-inner">
                                            <a href="assets/images/propmajestic.png" data-lightbox="example-1">
                                                <img src="assets/images/prop3 (1).png" alt="Portfolio">
                                            </a>
                                        ...
                                        <h2><a href="https://propmajestic.com/" target="_blank">Prop Majestic</a></h2>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 scroll-animation" data-animation="fade_from_left">
                                    <div class="portfolio-item portfolio-half">
                                        <div class="portfolio-item-inner">
                                            <a href="assets/images/my_portfolio.png" data-lightbox="example-1">
                                                <img src="assets/images/port1.png" alt="Portfolio">
                                            </a>
                                        ...
                                        <h2><a href="#">Personal Portfolio Website</a></h2>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 scroll-animation" data-animation="fade_from_right">
                                    <div class="portfolio-item portfolio-half">
                                        <div class="portfolio-item-inner">
                                            <a href="assets/images/faima.png" data-lightbox="example-1">
                                                <img src="assets/images/f1.png" alt="Portfolio">
                                            </a>
                                        ...
                                        <h2><a href="#">Faima Maharashtra</a></h2>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 scroll-animation" data-animation="fade_from_right">
                                    <div class="portfolio-item portfolio-half">
                                        <div class="portfolio-item-inner">
                                            <a href="assets/images/Perfromance.png" data-lightbox="example-1">
                                                <img src="assets/images/p2.png" alt="Portfolio">
                                            </a>
                                ...
                                <div class="col-md-6 scroll-animation" data-animation="fade_from_right">
                                    <div class="portfolio-item portfolio-half">
                                        <div class="portfolio-item-inner">
                                            <a href="assets/images/croma_clone.png" data-lightbox="example-1">
                                                <img src="assets/images/c7.png" alt="Portfolio">
                                            </a>
                                ...
                                <div class="col-md-6 scroll-animation" data-animation="fade_from_right">
                                    <div class="portfolio-item portfolio-half">
                                        <div class="portfolio-item-inner">
                                            <a href="assets/images/voicebot.png" data-lightbox="example-1">
                                                <img src="assets/images/vvv.png" alt="Portfolio">
                                            </a>
                                        ...
                                        <h2><a href="#">Voicebot Technologies</a></h2>
                                    </div>
                                </div>
                            </div>
                ...
                <section class="contact-area page-section scroll-content" id="contact">
                    <div class="custom-container">
                        <div class="contact-content content-width">
                            ...
                            <h3 class="scroll-animation" data-animation="fade_from_bottom">pachghareyashshree31@gmail.com</h3>
                            <p id="required-msg">* Marked fields are required to fill.</p>

                            <form class="contact-form scroll-animation" data-animation="fade_from_bottom" method="POST" action="contact.php">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="full_name" id="full-name" placeholder="Your Full Name" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="input-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="phone_number" id="phone-number" placeholder="Your phone number" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="input-group">
...
<!-- Mirrored from wpriverthemes.com/HTML/drake/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 27 Feb 2025 08:42:15 GMT -->
</html>